        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="font-mono text-xs text-foreground/60 md:text-base">/ Начните уже сегодня</p>
            </div>

            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:info@yavteme.ru"
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              >
                ...
                {submitSuccess && (
                  <p className="mt-3 text-center font-mono text-sm text-foreground/80">Заявка отправлена! Мы свяжемся с вами.</p>
                )}
              </div>
            </form>
          </div>
